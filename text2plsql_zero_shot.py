...
from utils.db_utils import check_plsql_executability, compare_plsql
...
if __name__ == "__main__":
    ...
    for idx, (raw_data, predicted_plsql) in enumerate(zip(raw_dataset, predicted_plsqls)):
        ...
        if compare_plsql(raw_data["database"], raw_data["table"], raw_data["plsql"], predicted_plsql, raw_data["call"]):
