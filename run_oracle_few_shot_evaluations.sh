...
CUDA_VISIBLE_DEVICES=6 python -u oracle_text2plsql_few_shot.py \
    ...
    --demonstration_set_path /home/zhanghang/opt/projects/researchprojects/text2PLSQL/data/oracle_data_procbench_train_1500.json \
    ...
    --new_similarity 1 \
    --similarity_w 0.5 \
    --test_question_skeletons_path /home/zhanghang/opt/projects/researchprojects/text2PLSQL/codes/cache/oracle_question_skeletons_procbench_test_300.cache \
    ...
    --plsql_skeleton_similarity_path /home/zhanghang/opt/projects/researchprojects/text2PLSQL/codes/cache/oracle_skeleton_similarity_procbench_test_300.cache \
    --host "localhost" \
    --port 1521